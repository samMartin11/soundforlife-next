      ...
      <div style={{ width: "100%", maxWidth: "1200px", margin: "0 auto", padding: "56px 1.5rem" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr_0.75fr] gap-6">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-sm leading-6 max-w-xs" style={{ color: "white" }}>
          ...
          {/* QUICK LINKS */}
          <div>
            <h4 className="font-bold mb-5" style={{ color: "white", marginBottom: "15px" }}>Quick Links</h4>
          ...
          {/* BRANDS */}
          <div>
            <h4 className="font-bold mb-5" style={{ color: "white", marginBottom: "15px" }}>Brands</h4>
            <div className="flex flex-col gap-3 text-sm text-gray-400">
          ...
          {/* LEARN */}
          <div>
            <h4 className="font-bold mb-5" style={{ color: "white", marginBottom: "15px" }}>Learn</h4>
            <div className="flex flex-col gap-3 text-sm text-gray-400">
          ...
          {/* CONTACT */}
          <div>
            <h4 className="text-base font-bold mb-5" style={{ color: "white", marginBottom: "15px" }}>Contact</h4>
            <div className="flex flex-col gap-3 text-sm text-gray-400">
        ...
        {/* BOTTOM BAR */}
        <div
          className="border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-3"
